...
Hello! I'm Manish, a software engineer focused on building robust, scalable web architectures and performant backend services. I design end-to-end applications using **JavaScript/TypeScript (React, Node.js)** and **Python**, with a strong interest in cloud infrastructure and AI/ML integration.
...
* **Frontend:** React.js, Tailwind CSS, Vite, Redux
* **Backend:** Node.js, Express.js, REST APIs, Microservices
* **Databases:** PostgreSQL, MongoDB, Firebase
* **Cloud & DevOps:** Amazon Web Services (AWS EC2, S3, IAM, Amplify), Docker, Git, GitHub Actions

---

### 📂 Featured Engineering Projects

#### 🚀 Project Name (e.g., Scalable E-Commerce API)
*Brief description of what the project does, the technical challenges solved, and its impact.*
